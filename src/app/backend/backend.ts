...
export class InMemDBService implements InMemoryDbService {
  ...
  createDb() {
                ...
                listAttributsParCategories: [
                  {
                    ...
                    etat: true,
                    dateCreation: new Date('07/03/2000'),
                    dateModification: new Date('07/03/1990'),                    type: IType.String,
                    valeursParDefaut: '',}
                  },
                  {
                    id: '',
          ...
          },
          {
            ...
            attributs: [
              ...
              },
              {
                ...
                etat: true,
                dateCreation: new Date('07/03/2000'),
                dateModification: new Date('07/03/1990'),                type: IType.Double,
                valeursParDefaut: '',
              },
              {
                id: '5',
    ...
    let etape: IEtape[] = [
      ...
      document:[{id: '1',titre: 'Note intervention',description: "Document delivre par le medecin ou un infirmier de l'etablissement",typeMouvement: 'Ajout',etat:true,affichagePrix:true,contientRessources:true,contientDistributeurs:true,
      missions: [{id: '1',libelle: 'Consultation', description: 'Consultation faite par une infirmière', etat: true, dateCreation: new Date('07/03/2000'),dateModification: new Date('07/03/1990'),idLogin: 'admin',service: {id: '1', libelle: 'Pharmacie', etat: true, dateDerniereModification: new Date('07/03/2000'),dateAttribution: new Date('07/03/1990'),
      dateFin: new Date('07/03/1990'),nombreTotalAttributions: 6, localisation:'douala', description:'bien', },},{id: '2',libelle: 'Consultation Spécialiste',description: 'Consultation faite par un médecin',etat: true,dateCreation: new Date('07/03/2000'),
      dateModification: new Date('07/03/1990'),idLogin: 'admin',
          service: {
            id: '2',
            libelle: 'Laboratoire',
            etat: true,
      ...
      document:[{ id: '3',titre: 'Fiche de soin',description:"Document delivre par le medecin ou un infirmier de l'etablissement",
      typeMouvement: 'Neutre',etat:true,affichagePrix:true,contientRessources:true, contientDistributeurs:true,
      missions: [{id: '1',libelle: 'Consultation', description: 'Consultation faite par une infirmière', etat: true, dateCreation: new Date('07/03/2000'),dateModification: new Date('07/03/1990'),idLogin: 'admin',service: {id: '1', libelle: 'Pharmacie', etat: true, dateDerniereModification: new Date('07/03/2000'),dateAttribution: new Date('07/03/1990'),
      dateFin: new Date('07/03/1990'),nombreTotalAttributions: 6, localisation:'douala', description:'bien', },},{id: '2',libelle: 'Consultation Spécialiste',description: 'Consultation faite par un médecin',etat: true,dateCreation: new Date('07/03/2000'),
      dateModification: new Date('07/03/1990'),idLogin: 'admin',
          service: {
    ...
    let parours: IParours[] = [
      { id: '1', libelle: 'debut',dateCreation:new Date("07/03/2000"),
        ...
        document:[{id: '1',titre: 'Note intervention',description: "Document delivre par le medecin ou un infirmier de l'etablissement",typeMouvement: 'Ajout',etat:true,affichagePrix:true,contientRessources:true,contientDistributeurs:true,
        missions: [{id: '1',libelle: 'Consultation', description: 'Consultation faite par une infirmière', etat: true, dateCreation: new Date('07/03/2000'),dateModification: new Date('07/03/1990'),idLogin: 'admin',service: {id: '1', libelle: 'Pharmacie', etat: true, dateDerniereModification: new Date('07/03/2000'),dateAttribution: new Date('07/03/1990'),
        dateFin: new Date('07/03/1990'),nombreTotalAttributions: 6, localisation:'douala', description:'bien', },},
        {id: '2',libelle: 'Consultation Spécialiste',description: 'Consultation faite par un médecin',etat: true,dateCreation: new Date('07/03/2000'),
        dateModification: new Date('07/03/1990'),idLogin: 'admin',
            service: {
              id: '2',
              libelle: 'Laboratoire',
