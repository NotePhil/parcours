...
export class InMemDBService implements InMemoryDbService {
  ...
  createDb() {
    ...
    let attributs: IAttributs[] = [
      ...
      {id: '2',titre: 'poids',description: "poids de l'individu",etat: true,dateCreation: new Date('07/03/2000'),dateModification: new Date('07/03/1990'),type: TypeTicket.Double,ordre: 0,obligatoire: false,valeursParDefaut: '',},
      ...
      {id: '4',titre: 'age',description: "age de l'individu",etat: true,dateCreation: new Date('07/03/2000'),dateModification: new Date('07/03/1990'),type: TypeTicket.Double,ordre: 0,obligatoire: false,valeursParDefaut: '',},
    ...
    let documents: IDocument[] = [
      ...
      },
      {
        ...
        attributs: [
          {id: '1', titre: 'taille', description: "taille de l'individu",etat: true,dateCreation: new Date('07/03/2000'),dateModification: new Date('07/03/1990'),type: TypeTicket.Double, ordre: 0, obligatoire: false, valeursParDefaut: '', },
          { id: '6',titre: 'teint',description: "teint de l'individu", etat: true,dateCreation: new Date('07/03/2000'), dateModification: new Date('07/03/1990'), type: TypeTicket.String,ordre: 0,obligatoire: false,valeursParDefaut: '',},
        ...
        categories: [
          { id: '1', nom: 'informations personelles',ordre: 1,
            listAttributs: [
              ...
              {id: '4', titre: 'age',description: "age de l'individu",etat: true,dateCreation: new Date('07/03/2000'),dateModification: new Date('07/03/1990'),type: TypeTicket.Double,ordre: 1, obligatoire: false, valeursParDefaut: '', },
        ...
        categories: [
          { id: '1', nom: 'informations personelles', ordre: 1,
            listAttributs: [
              ...
              {id: '1',titre: 'taille',description: "taille de l'individu",etat: true,dateCreation: new Date('07/03/2000'),dateModification: new Date('07/03/1990'),type: TypeTicket.Double,ordre: 2,obligatoire: false,valeursParDefaut: '',},
              {id: '4',titre: 'age',description: "age de l'individu",etat: true,dateCreation: new Date('07/03/2000'),dateModification: new Date('07/03/1990'),type: TypeTicket.Double,ordre: 3,obligatoire: false,valeursParDefaut: '',},
            ],
          },
        ...
        categories: [
          {
            ...
            listAttributs: [{ id: '1', titre: 'taille', description: "taille de l'individu",etat: true,dateCreation: new Date('07/03/2000'),dateModification: new Date('07/03/1990'),type: TypeTicket.Double,ordre: 1,obligatoire: false,valeursParDefaut: '',},
              {id: '4',titre: 'age',description: "age de l'individu",etat: true,dateCreation: new Date('07/03/2000'),dateModification: new Date('07/03/1990'),type: TypeTicket.Double,ordre: 2,obligatoire: false,valeursParDefaut: '',},
              {id: '6',titre: 'teint',description: "teint de l'individu",etat: true,dateCreation: new Date('07/03/2000'),dateModification: new Date('07/03/1990'),type: TypeTicket.String,ordre: 3,obligatoire: false, valeursParDefaut: '',},
            ],
          },
          {
